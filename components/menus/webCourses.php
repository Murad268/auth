...
<head>
   ...
   <title>web devolopment kursları</title>
</head>
<body>
      ...
      <div class="courses__wrapper">
         ...
         <div class="allCourses__result">
            ...
            <div class="allCourses__result__wrapper">
               <div class="html webDevop frontendDevop azerbaijanWEb without allCourses__result__course">
               ...
               <div style="display: none;" class="html englishLesson britainEnglish azerbaijanEnglish a1Level allCourses__result__course">
